...
Hay una app auxiliar para introducir los municipios con sus sitios asociados a ellos en las bases de datos y pasarlos al usuario: Windows ([**_AdminTurismo_**](https://github.com/SergioR29/AdminTurismo)).
